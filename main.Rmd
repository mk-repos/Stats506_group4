...
fig = px.choropleth(sf_merge_m_03_11, locations="state",
                    locationmode = "USA-states",
                    color="total_pos",scope="usa",
                    hover_name="NAME", animation_frame="Month",
...
# save as html                                            
fig.write_html('Monthly_case.html', config=config)
```
...
cap = paste0("***Figure: Interactive choropleth map of total count of",
             " COVID-19 positives per month in each state***")
htmltools::includeHTML("./python_files/Monthly_case.html")
```

![***Figure: Interactive choropleth map of total count of COVID-19 positives per month in each state***](./python_files/Monthly_case.html)

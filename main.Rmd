...
Drawing the cholopleth map in SAS is simple since SAS have already made the shapefile for us. We can use the data map.us to see what shapefiles look like in the SAS. 

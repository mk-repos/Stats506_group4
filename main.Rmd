...
The final value data you got should have distinct records which the key variables you matched with shapefile should be the primary keys for your value data. 

...
```{r demonstrate_sf_points, message=FALSE, warning=FALSE, echo=FALSE, fig.height=5}
...
```{r draw_michigan_map, echo=FALSE, warning=FALSE, fig.height=5}
...
There are not many things you have to worry about when drawing a map because the software will take care of most of the tedious works. However it should be noted that geographic coordinate systems are actually quite complex, and it's important to understand how it works because, as we'll see in this tutorial, sometimes you'll need to transform the coordinates.

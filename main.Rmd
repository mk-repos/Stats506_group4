...
proc sgplot data=Usmap noautolegend;
	...
	polygon x=X y=Y id=polyID/ fill outline lineattrs=(color=black) 
	    colorresponse=Quarter1 dataSkin=matte fill 
	    colormodel=(white red str) name='map';
	    gradlegend 'map';
	xaxis display=none;
	yaxis display=none;
run;
...
# Extended Example: Using `GMAP` procedure to draw the choropleth map in SAS
